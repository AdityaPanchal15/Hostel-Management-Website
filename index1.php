...
<div class="container" style="margin-left:0px;">
  <div class="card mt-2" style="width:1330px">
    ...
    <div class="card-body" >
      <table class="table table-bordered">
        ...
        <?php foreach($people4 as $person4): ?>
          <tr>
            <td><?= $person4->User_Id; ?></td>
            <td><?= $person4->first_name; ?></td>
			<td><?= $person4->last_name; ?></td>
            <td><?= $person4->mobile_no; ?></td>
			<td><?= $person4->email; ?></td>
			<td><?= $person4->city; ?></td>
			<td><?= $person4->college; ?></td>
			<td><?= $person4->reference; ?></td>
			
		    
           	<td>
              
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="delete1.php?id=<?= $person4->User_Id ?>" class='btn btn-danger'>Delete</a>
            </td>
